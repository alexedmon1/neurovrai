...
subject_list = [sub_directory + '1640101/',
                sub_directory + '2910101/']

#with open('/mnt/elysium/IRC805/rest/irc805_rest_status.txt') as f:
...
def preprocessing(x):
    sub = subject_name(x)
    rest = '/mnt/elysium/IRC805/heudiconv/'+str(sub)+'/func/mean_merest.nii.gz'
    ...
    if os.path.exists(rest):
        ...
        print('Done!')
        with open('/mnt/elysium/IRC805/rest/irc805_rest_status.txt', 'a') as file1:
            file1.write(x +' \n')
    else:
        with open('/mnt/elysium/IRC805/rest/irc805_rest_status.txt', 'a') as file1:
            file1.write(x +' \n')
