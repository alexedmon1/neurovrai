...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  3 10:38:01 2025
...
def rest_preproc1(base, base_dir):
    """
    First preprocess prepares images for Tedana separately. Each TE is processed separately. 
        McFlirt performed on middle TE then applied to all
        Slice timing performed on all? Maybe not.
        Distortion correction should be done with TOPUP

        TOPUP -> Slice Timing? -> MCFLIRT on Middle TE and applied to 
        
        Exports then go to TEDANA
        
    Parameters
    ----------
    base : file base for finding echoes.
    rest_image : TYPE
        DESCRIPTION.
    base_dir : TYPE
        DESCRIPTION.
