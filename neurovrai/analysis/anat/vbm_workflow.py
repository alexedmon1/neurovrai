...
def run_vbm_analysis(
    ...
    """
    Run group-level VBM statistical analysis using pre-generated design matrices

    Args:
        vbm_dir: Directory containing prepared VBM data (from prepare_vbm_data)
        design_dir: Directory containing pre-generated design.mat, design.con, and participants file
                   (generated by generate_design_matrices.py)
    ...
    Outputs:
        {vbm_dir}/stats/
            design.mat, design.con - Copied from design_dir
    ...
    validation_result = validate_design_alignment(
        ...
        mri_files=[merged_file],  # 4D merged file
    ...
    logger.info(f"✓ Copied design files to stats directory:")
