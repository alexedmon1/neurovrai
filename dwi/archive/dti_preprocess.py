...
def dti_preproc(subject_no, basedir):
    ...
    templates = {'dwi': 'sub-'+str(subject_no)+'_dwi_b1000_b2000_merged.nii.gz',
                 'bvecs': 'sub-'+str(subject_no)+'_dwi_combined.bvec',
                 'bvals': 'sub-'+str(subject_no)+'_dwi_combined.bval',
                 't1w': 'sub-'+str(subject_no)+'_t1w.nii.gz'}
    ...
    dti_eddy = Node(fsl.Eddy(in_acqp='/mnt/elysium/IRC805/dti/acqp.txt', 
                             in_index='/mnt/elysium/IRC805/dti/index.txt',
    ...
    wf = Workflow(name='dti_preprocess', base_dir=basedir+'/dti/'+subject_no)
...
#subject_list = glob('/mnt/elysium/IRC805/dti/preprocess/*/')
subject_list = ['/mnt/elysium/IRC805/dti/preprocess/2930302/',
                    '/mnt/elysium/IRC805/dti/preprocess/3330101/']
