...
subject_list = glob('/mnt/elysium/IRC805/dti/dtifit/FA/*_target_RD.nii.gz')
JHU_label_map = '/home/edm9fd/fsl/data/atlases/JHU/JHU-ICBM-labels-2mm.nii.gz'
...
df.to_csv('/mnt/elysium/IRC805/data/JHU_dwi_tracts_MD_'+stat+'.csv')
